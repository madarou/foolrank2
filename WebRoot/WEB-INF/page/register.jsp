		...
		<article class="regPanel">
			<form id="regForm" action = "${path}/register/createuser" method= "post" >
			 <fieldset class="regInfo">
				...
				<label for="question" class="regLabel"><span>验证问题:${validatequestion}</span></label>
				<label for="answer" class="regLabel"><span>回答</span><span class="dot">*</span></label>
				<input type="text" name="answer" id="answer" class="regInput"/><span id = "answerInfo" class="alertInfo"></span><input id="rightanswer" type ="hidden" value="${validateanswer}"></span>
				...
				<label for="confirmPassword" class="regLabel"><span>确认密码</span><span class="dot">*</span></label>
				<input type="password" id="confirmPassword" class="regInput"/>
			</fieldset>
