	...
	<div class="container">
		...
		<div class="span8">
			...
			<div>
				<div class="row">
				  <div class="span4">
				    <input type="text" class="input-medium search-query" id="quizContent"></input>
					<button class="btn" id="btn_search">搜索试卷</button>				  
				  </div>		
				</div>
				...
				<div class="row mainzone">
					<table class=" table  table-bordered"
						...
						<thead id='tablehead'>
							<tr>
								<th align="left" style="color: #000">试卷列表</th>
							</tr>
			...
			<div class="row btngroup" id="">
				<div class="span2">
					<button type="button" class="btn" id="createquiz">新建试卷</button>
				</div>

				<div class="span2">
					<button type="button" class="btn" id="editquiz">修改试卷</button>
				</div>

				<div class="span2">
					<button type="button" class="btn" id="delquiz">删除试卷</button>
				</div>
			</div>
...
<!-- register Modal end-->
	...
	<script src="<%=path%>/resources/js/quizmanage.js"></script>
